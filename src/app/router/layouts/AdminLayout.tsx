        ...
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-border bg-white px-4 sm:px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="hidden sm:block text-sm font-semibold text-text-primary">iDap Admin Console</span>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  ...
                  <p className="text-xs text-text-muted leading-none mt-0.5 capitalize">{user?.admin_role?.replace('_', ' ')}</p>
                </div>
              ...
              {profileOpen && (
                <div className="absolute right-0 mt-1.5 w-48 rounded-xl border border-border bg-white shadow-lg py-1 z-50">
                  <div className="px-3 py-2 border-b border-border">
                    ...
                    <p className="text-xs text-text-muted capitalize">{user?.admin_role?.replace('_', ' ')}</p>
                  </div>
                  <button
